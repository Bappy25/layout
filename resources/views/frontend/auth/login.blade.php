                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group row">
                            <label for="identity" class="col-md-4 col-form-label text-md-right">{{ __('Username/E-Mail') }}</label>
                            ...
                            <div class="col-md-6">
                                ...
                                @if(session()->has('login_error'))
                                  <p class="text-danger small"><strong>{{ session()->get('login_error') }}</strong></p>
                                  @php 
