        ...
        <div class="card">
            ...
            <div class="body">
                ...
                <div class="form-group form-float">
                    <div class="form-line">
                        {!! Form::text("keywords", empty($terms->keywords) ? null : $terms->keywords, ['class'=>'form-control', 'data-role' => 'tagsinput', 'placeholder' => 'SEO Keywords']) !!}
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="form-line">
                        {!! Form::textarea("details", empty($terms->details) ? null : $terms->details, ['class'=>'tinymce']) !!}
                    </div>
                </div>
